...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002174514960')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Leazy_Boy') # Support Chat Link Without https:// or @
