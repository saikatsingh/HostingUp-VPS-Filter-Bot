...
async def start():
    ...
    for name in files:
        with open(name) as a:
            ...
            print("Tech AMROBOTS Imported => " + plugin_name)
    if URL:
    ...
    me = await AmRobotsTechBot.get_me()
    temp.ME = me.id
    ...
    await AmRobotsTechBot.send_message(chat_id=LOG_CHANNEL, text=script.RESTART_TXT.format(today, time))
